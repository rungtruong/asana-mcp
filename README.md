...
- **Subtask Management**
  - Create new subtasks under existing tasks with name, description, due date, and assignee
  - List all subtasks for a parent task
  - Update existing subtasks (name, description, due date, assignee, completion status)
  - Delete subtasks
...
Parameters:
- `parentTaskId` (string, required): The ID of the parent task
- `name` (string, required): The name of the subtask
- `description` (string, optional): The description of the subtask
- `dueDate` (string, optional): The due date of the subtask (ISO format)
- `assignee` (string, optional): The assignee of the subtask

#### list-subtasks

Lists all subtasks for a parent task.

Parameters:
- `parentTaskId` (string, required): The ID of the parent task to list subtasks from
...
- `name` (string, optional): The new name of the subtask
- `description` (string, optional): The new description of the subtask
- `dueDate` (string, optional): The new due date of the subtask (ISO format)
- `assignee` (string, optional): The new assignee of the subtask
- `completed` (boolean, optional): Whether the subtask is completed
...
│   ├── subtasks.js     # Subtask management functions
